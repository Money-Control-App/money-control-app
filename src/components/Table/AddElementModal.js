        ...
        <div className="modal-overlay">
          <div className="modal-window">
            ...
            <div className="modal-footer">
              <ButtonsForTable id='btn-add' className={'btn-add'} key="bn87mb87b6n765fg4" clickBtn={() => setModalOpen(false)}>
                Close
            </ButtonsForTable>
              <ButtonsForTable key="f87gd98f7gd8fg" className={'btn-add'} clickBtn={addElement}>
                Add
            </ButtonsForTable>
            </div>
          </div>
